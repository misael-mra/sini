...
<nav class="navbar navbar-inverse">
    ...
    <div class="container">
        <h2>Número da notificação que deseja excluir:</h2>
        <form method="POST" action="delete_os.php">
            <div class="form-group">
                <label for="local">Número da Notificação:</label>
                <input type="text" class="form-control" id="oser" placeholder="Número Notificação" name="oser"
                    required />
            </div>
