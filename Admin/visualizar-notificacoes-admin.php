...
$sql_code = "select contador,Local,Tecnico,DataHora,Status,servico from notificacoes ORDER BY contador DESC LIMIT $item, $itens_por_pagina";
$execute = $conn->query($sql_code) or die($conn->error);
$produto = $execute->fetch_assoc();
$num = $execute->num_rows;
$num_total = $conn->query("select contador,Local,Tecnico,DataHora,Status,servico from notificacoes")->num_rows;
...
<head>
    <title>Todas Notificações</title>
    <meta charset="utf-8">
...
<nav class="navbar navbar-inverse">
    ...
    <div class="container">
        ...
        <nav>
            <ul class="pagination">
                <li>
                    <a href="visualizar-notificacoes-admin.php?pagina=0" aria-label="Previous">
			...
			?>
                <li <?php echo $estilo; ?>><a
                        href="visualizar-notificacoes-admin.php?pagina=<?php echo $i; ?>"><?php echo $i+1; ?></a></li>
                <?php } ?>
                <li>
                    <a href="visualizar-notificacoes-admin.php?pagina=<?php echo $num_paginas-1; ?>" aria-label="Next">
