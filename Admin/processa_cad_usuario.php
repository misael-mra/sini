	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<a class="btn btn-danger btn-lg" href="insere_usuario_res.php">
					Entendido
				</a>
			</div>
		</div>
  ...
  <div class="modal fade" id="myModal2">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal footer -->
        <div class="modal-footer">
		  <a class="btn btn-success" href="insere_usuario_res.php">
   Entendido
</a>
        </div>
      </div>
...
if($link === false){
	...
	$senhatecni = $_POST['senhatec'];
		 ...
		 $sql2 = "INSERT INTO usuarios(nome,username,password,role) VALUES ('$nomecompletotec','$nomesistec','$senhatecni','usuario')";
   ...
   echo '<script type="text/javascript"> $("#myModal").modal("show")</script>';
	...
	$sql = "INSERT INTO coordenadores(nome,NomeCompleto) VALUES ('$nomesistec','$nomecompletotec')";
