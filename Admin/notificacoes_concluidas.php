...
$sql_code = "select contador,Local, Tecnico, DataHora,Status,servico from notificacoes WHERE  Status='Feito' ORDER BY contador DESC LIMIT $item, $itens_por_pagina";
$execute = $conn->query($sql_code) or die($conn->error);
$produto = $execute->fetch_assoc();
$num = $execute->num_rows;
$num_total = $conn->query("select contador,Local, Tecnico, DataHora,Status,servico from notificacoes WHERE Status='Feito'")->num_rows;
...
<head>
    <title>Notificações Concluídas</title>
    <meta charset="utf-8">
...
<nav class="navbar navbar-inverse">
    ...
    <div class="container">
        ...
        <nav>
            <ul class="pagination">
                <li><a href="notificacoes_concluidas.php?pagina=0" aria-label="Previous">
			...
			?>
                <li <?php echo $estilo; ?>><a
                        href="notificacoes_concluidas.php?pagina=<?php echo $i; ?>"><?php echo $i+1; ?></a></li>
                <?php } ?>
                <li>
                    <a href="notificacoes_concluidas.php?pagina=<?php echo $num_paginas-1; ?>" aria-label="Next">
